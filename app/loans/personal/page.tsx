...
export default function PersonalLoan() {
  ...
  const [interestRate, setInterestRate] = useState<number>(14); // fixed 14%
    ...
    <div className={styles.container}>
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.title}>Personal Loan</h1>
          <p className={styles.subtitle}>
            Fulfill your personal needs with our flexible Personal Loans.
          </p>
        </div>
      </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          <h2>Purpose</h2>
          <p>
            For personal needs like marriage, travel, medical expenses, or
            any urgent financial requirements.
          </p>
        </div>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.loanDetails}>
            ...
            <div className={styles.detailCard}>
              <h3>Eligibility</h3>
              <p>
                Based on income, repayment capacity, and credit history.
              </p>
            </div>
            <div className={styles.detailCard}>
        ...
        <div className={styles.section}>
          <h2>USP</h2>
          <ul>
            <li>Quick Disbursal for Personal Needs</li>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.otherLoans}>
            ...
            <div className={styles.loanCard}>
              <img src="/images/educational-loan.jpg" alt="Educational Loan" />
              <h3>Educational Loan</h3>
              <a href="/educational-loan">Know More</a>
            </div>
          </div>
        </div>
      </div>
