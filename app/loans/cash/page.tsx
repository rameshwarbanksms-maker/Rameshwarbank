...
export default function CashCreditLoan() {
  ...
  const [interestRate, setInterestRate] = useState<number>(12); // fixed 12%
    ...
    <div className={styles.container}>
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.title}>Cash Credit Loan</h1>
          <p className={styles.subtitle}>
            Access working capital instantly with our Cash Credit Loans.
          </p>
        </div>
      </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          <h2>Purpose</h2>
          <p>For short-term business funding, working capital needs, or cash flow management.</p>
        </div>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.loanDetails}>
            ...
            <div className={styles.detailCard}>
              <h3>Eligibility</h3>
              <p>Based on business turnover, credit score, and repayment capacity.</p>
            </div>
            <div className={styles.detailCard}>
        ...
        <div className={styles.section}>
          ...
          <ul>
            ...
            <li>Fixed Competitive Interest Rate</li>
            <li>Support for Short-term Business Needs</li>
          </ul>
